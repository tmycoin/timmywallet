...
const QString BITCOIN_IPC_PREFIX("timmycoin:");

static QString ipcServerName()
{
    QString name("timmycoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start timmycoin: click-to-pay handler");
    else
...
{
    // clicking on timmycoin: URLs creates FileOpen events on the Mac:
