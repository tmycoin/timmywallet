...
void MainWindow::setMainWindowTitle() {
  setWindowTitle(QString(tr("Timmycoin Wallet %1")).arg(Settings::instance().getVersion()));
}
...
#else
  m_langPath = "/opt/timmycoin/languages";
#endif
  QDir dir(m_langPath);
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.Timmycoin.net in Documentation section"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Timmycoin Wallet %1")).arg(Settings::instance().getVersion());
